...
class ParseTrakEM2(object):
    ...
    def set_fill(self,colors,opacity=0.5):
        ...
        ----------
        colors : list
          List of tuples - two options w/ or w/o opacity 
          option 1: [(cell_name1,color1), (cell_name2, color2)...]
          option 2: [(cell_name1,color1,opacity1), (cell_name2, color2,opacity2)...]
